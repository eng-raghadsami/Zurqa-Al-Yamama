...
function TermCard({ term }: { term: GlossaryTerm }) {
  return (
    <article className="glass-panel p-6 rounded-2xl shadow-sm border border-outline-variant/10 group hover:shadow-xl hover:-translate-y-1 transition-all duration-300 flex flex-col h-full">
  ...
  return (
    <main className="space-y-10">
      ...
      <section className="rounded-2xl glass-panel border border-outline-variant/10 overflow-hidden">
        <div className="px-6 py-10 md:px-12 md:py-14 text-center max-w-3xl mx-auto">
          ...
          <h1 className="font-display-lg text-display-lg-mobile md:text-display-lg mb-4">
            مرجع المصطلحات{" "}
            <span className="gold-gradient-text">الرقمية</span>
          </h1>
        ...
        <section aria-labelledby="featured-term-heading">
          <div className="flex items-center justify-between mb-5">
            <h2
              ...
              className="font-headline-md text-primary flex items-center gap-2"
            >
              <span className="w-1.5 h-6 bg-gold-metallic-start rounded-full" />
              مفهوم الشهر
            </h2>
          </div>
          <article className="glass-panel rounded-2xl border border-outline-variant/10 shadow-sm overflow-hidden">
            <div className="grid grid-cols-1 lg:grid-cols-5 gap-0">
              ...
              <div className="lg:col-span-2 relative min-h-[220px] lg:min-h-full order-1 lg:order-2">
                <img
      ...
      <section aria-labelledby="glossary-heading">
        <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-3 mb-6">
          <div>
            <h2 id="glossary-heading" className="font-headline-md text-primary">
              دليل المصطلحات
            </h2>
      ...
      <section className="p-8 md:p-10 text-center glass-panel rounded-2xl border-2 border-dashed border-outline-variant/40">
        ...
        <button
          type="button"
          className="px-8 py-3 bg-primary text-on-primary rounded-xl font-bold hover:scale-105 transition-transform"
        >
